...
sourcefolder = '/heartwood/onedrive/Documents/KAIST/CS479 3D/project/backup/FAUST_r'
...
for i_b in range(len(bi1)):
    ...
    p_s, f_s = readOFF(join(sourcefolder, 'off_2',meshname.format(i_s)))
    p_t, f_t = readOFF(join(sourcefolder, 'off_2', meshname.format(i_t)))
    n_s = p_s.shape[0]
    n_t = p_t.shape[0]
    ...
    geodist_folder = '/heartwood/onedrive/Documents/KAIST/CS479 3D/project/backup/FAUST_r/spectral/'
    ...
    # vts
    vts_folder = '/heartwood/onedrive/Documents/KAIST/CS479 3D/project/backup/FAUST_r/corres/'
...
print(to_save.shape)
np.save('FAUST_matches_2ours'+str(n_tr), to_save)
np.save('FAUST_matches_2ours_ref'+str(n_tr), to_save_ref)
